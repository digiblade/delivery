...
class SMMyOrder extends StatefulWidget {
  SMMyOrder({Key key}) : super(key: key);

  @override
  _SMMyOrderState createState() => _SMMyOrderState();
}

class _SMMyOrderState extends State<SMMyOrder> {
  @override
